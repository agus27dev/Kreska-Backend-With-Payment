        ...
        <div class="col-md-5 mb-5">
            <div class="card border-0 shadow">
                ...
                <div class="card-body">
                    ...
                    <p>
                        Simpan recovery code ini dengan aman. Ini dapat
                        digunakan untuk memulihkan akses ke akun Anda jika perangkat otentikasi
                        dua faktor Anda hilang.
                    </p>
            ...
            <div class="card border-0 shadow mt-3 mb-4">
                <div class="card-header">
                    <h6 class="m-0 font-weight-bold">
                        <i class="fas faunlock"></i> UPDATE PASSWORD
                    </h6>
                </div>
                <div class="card-body">
