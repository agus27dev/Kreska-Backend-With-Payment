...
<head>
    ...
    <title>{{ $title ?? config('app.name') }} - Admin Kreska Store</title>
    ...
    <style>
        ...
        .bg-gradient-primary{
            background-color: #425c5a !important;
            background-image: linear-gradient(120deg, #425c5a 100%, #425c5a 100%) !important;
        ...
        <ul class="bg-gradient-primary navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/admin/dashboard">
                <div class="sidebar-brand-icon">
                    <img class="brand" src="{{asset('assets/img/company.png')}}" alt="">
                </div>
                <div class="sidebar-brand-text mx-3">KRESKA STORE</div>
            </a>
            <!-- Divider -->
            ...
            <li class="nav-item {{ Request::is('admin/category*') ? ' active' : '' }} {{ Request::is('admin/product*') ? ' active' : '' }}">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo"
                    aria-expanded="true" ariacontrols="collapseTwo">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>&copy; 2021 Kreska Store</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
